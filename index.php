...
<html lang="en" class="dark-theme">
  <head>
    ...
    <link rel="shortcut icon" href="<?php echo bloginfo('template_url'); ?>/assets/favicon-af54a06d.ico" type="image/x-icon" />
    ...
    <div class="wrapper">
      <div class="wrapper_top"><header class="header" id="hero">
  ...
  <div class="hero__inner container">
    <div class="hero__me">
      ...
      <div class="hero__imgWrapper">
        <img class="hero__img" src="<?php echo bloginfo('template_url'); ?>/assets/me-light-a558d0b5.png" />
      ...
      <div class="hero__desctopDecorWrapper">
        ...
        <div class="hero__desctopDecor hero__desctopDecor_front">
          ...
          <img class="hero__desctopDecorImg" src="<?php echo bloginfo('template_url'); ?>/assets/desctopDecor-d30209a1.svg" />
        </div>
      </div>
    </div>
  ...
  <div class="projects__inner inner ">
    ...
    <div class="projects_listContainer">
      ...
      <ul class="projects__list">
        ...
        <li class="projects__item">
          <article class="projects__project">
            <img class="projects__img" src="<?php echo bloginfo('template_url'); ?>/assets/Salute-e2584184.jpg" />
            <p class="projects__name">Ola messenger</p>
            <a href="https://loquacious-ganache-815e33.netlify.app/" target="_blank" class="projects__link">link to
              site</a>
            <a href="https://github.com/Andrew213/Messenger" target="_blank" class="projects__link">link to code</a>
            <p class="projects__about">
              Классный проект с использованием TypeScript, ViteJS, EventBust для
              управления событиями, WebSocket для обмена сообщениями. Плюс за
              кастомный роутинг на TypeScript и тестирование с помощью Chai и
        ...
        <li class="projects__item">
          <article class="projects__project">
            <img class="projects__img" src="<?php echo bloginfo('template_url'); ?>/assets/Tetris-3e494f44.jpg" />
            ...
            <a href="https://github.com/Andrew213/tetra-tetris" target="_blank" class="projects__link">link to code</a>
            <p class="projects__about">
        ...
        <li class="projects__item">
          <article class="projects__project">
            <img class="projects__img" src="<?php echo bloginfo('template_url'); ?>/assets/hhbot-9e7cd220.png" />
        ...
        <li class="projects__item">
          <article class="projects__project">
            <img class="projects__img" src="<?php echo bloginfo('template_url'); ?>/assets/lt-6d35c71b.webp" />
            ...
            <a href="https://effulgent-praline-98eb7c.netlify.app/" target="_blank" class="projects__link">link to
              site</a>
            <a href="https://github.com/Andrew213/Little_Tail_acid_test" target="_blank" class="projects__link">link to
              code</a>
            <p class="projects__about">
        ...
        <li class="projects__item">
          <article class="projects__project">
            <img class="projects__img" src="<?php echo bloginfo('template_url'); ?>/assets/Blanchard-8c46f04d.jpg" />
            ...
            <a href="https://github.com/Andrew213/Blanchard" target="_blank" class="projects__link">link to code</a>
            <p class="projects__about">
        ...
        <li class="projects__item">
          <article class="projects__project">
            <img class="projects__img" src="<?php echo bloginfo('template_url'); ?>/assets/gta-72e37b9e.jpg" />
            <p class="projects__name">Pairs game</p>
            <a href="http://groove4life.tmweb.ru/" target="_blank" class="projects__link">link to site</a>
            <a href="https://github.com/Andrew213/game-pair_" target="_blank" class="projects__link">link to code</a>
            <p class="projects__about">
        ...
        <li class="projects__item">
          <article class="projects__project">
            <img class="projects__img" src="<?php echo bloginfo('template_url'); ?>/assets/MartPlace-912b25e2.jpg" />
            <p class="projects__name">MartPlace</p>
            <a href="http://market-place.tmweb.ru/" target="_blank" class="projects__link">link to site</a>
            <a href="https://github.com/Andrew213/marketplace" target="_blank" class="projects__link">link to code</a>
            <p class="projects__about">
        ...
        <li class="projects__item">
          <article class="projects__project">
            <img class="projects__img" src="<?php echo bloginfo('template_url'); ?>/assets/lendings-d83ed6ef.jpg" />
        ...
        <li class="projects__item">
          <article class="projects__project">
            <img class="projects__img" src="<?php echo bloginfo('template_url'); ?>/assets/Currency-e491a376.jpg" />
            ...
            <a href="https://github.com/Andrew213/CurrencyConverter" target="_blank" class="projects__link">link to
              code</a>
            <p class="projects__about">
        ...
        <li class="projects__item">
          <article class="projects__project">
            <img class="projects__img" src="<?php echo bloginfo('template_url'); ?>/assets/rpg-ca15e47a.jpg" />
            <p class="projects__name">RPG Skills</p>
            <a href="https://main--helpful-cucurucho-3e702f.netlify.app/" target="_blank" class="projects__link">link to
              site</a>
            <a href="https://github.com/Andrew213/RPG-test" target="_blank" class="projects__link">link to code</a>
            <p class="projects__about">
...
</section> <section class="skills" id="skills">
...
</section> <section class="tools" id="tools">
  ...
  <div class="contacts__inner inner container">
    ...
    <div class="contacts__list">
      <div class="contacts__item contacts__item-mail">
        ...
        <a href="mailto:a.kochanov31@yandex.ru" class="button contacts__mail"
          >Связаться</a
        >
      </div>
      ...
      <div class="contacts__tgInstWrapper">
        <a target="_blank" href="https://t.me/andreikochanov" class="contacts__item contacts__item-tg">
          <div class="contacts__img hero__socialItem hero__socialItem">
            <div
              class="hero__socialLink hero__socialLink_tg"
            ></div>
          </div>
        ...
        <a href="https://github.com/Andrew213" target="_blank" class="contacts__item contacts__item-git">
          <div class="contacts__img hero__socialItem hero__socialItem">
            <div
              ...
              href="#"
              target="_blank"
              class="hero__socialLink hero__socialLink_git"
            ></div>
          </div>
            <span class="contacts__name">GitHub</span>
        </a>
        <a target="_blank" href="https://instagram.com/ludovikxlv?igshid=ZDdkNTZiNTM=" class="contacts__item contacts__item-inst">
          <div class="contacts__img hero__socialItem hero__socialItem">
            <div
              class="hero__socialLink hero__socialLink_inst"
            ></div>
          </div>
          <span class="contacts__name">Instagram</span>
        </a>
      </div>
      <a    target="_blank" href="https://t.me/andreikochanov" class="contacts__item contacts__item-sm contacts__item-inst">
      <div  
    class="contacts__img hero__socialItem hero__socialItem">
        <div
          class="hero__socialLink hero__socialLink_tg"
        ></div>
      </div>
    ...
    <a href="https://github.com/Andrew213" target="_blank" class="contacts__item contacts__item-sm contacts__item-git">
      <div class="contacts__img hero__socialItem hero__socialItem">
        <div
          rel="stylesheet"
          href="#"
    ...
    <a    href="https://instagram.com/ludovikxlv?igshid=ZDdkNTZiNTM="
    target="_blank" class="contacts__item contacts__item-sm contacts__item-inst">
      <div class="contacts__img hero__socialItem hero__socialItem">
        <div
          rel="stylesheet"
    ...
    <noscript
      ><div>
        <img
          src="https://mc.yandex.ru/watch/95285034"
